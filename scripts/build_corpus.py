...
SOURCE_FLAGS = {
    ...
    "avx128_compare.c": ("-mavx2",),
    "avx128_test.c": ("-mavx",),
    "avx_variable_shift.c": ("-mavx2", "-mno-vzeroupper"),
    "avx_movmskb.c": ("-mavx2", "-mno-vzeroupper"),
    ...
    "avx256_byte_shuffle.c": ("-mavx2", "-mno-vzeroupper"),
    "avx256_permute.c": ("-mavx", "-mno-vzeroupper"),
