...
static volatile double scalar_threshold = 3.0;

__attribute__((noinline)) static int compare_scalar_rip_relative(double value) {
    return value > scalar_threshold ? 1 : 0;
}
...
int main(void) {
    ...
    const int scalar_rip_result = compare_scalar_rip_relative(4.0);
